...
for /F %%F in ('dir /b LIBRARIES_FOR\ARDUINO\PwmFrequency\*.h') do clang-format.exe -i -style=file LIBRARIES_FOR\ARDUINO\PwmFrequency\%%F
:for /F %%F in ('dir /b LIBRARIES_FOR\ARM\STM32F1\*.h')          do clang-format.exe -i -style=file LIBRARIES_FOR\ARM\STM32F1\%%F
:for /F %%F in ('dir /b LIBRARIES_FOR\ARM\STM32F4\*.h')          do clang-format.exe -i -style=file LIBRARIES_FOR\ARM\STM32F4\%%F
:for /F %%F in ('dir /b LIBRARIES_FOR\AVR\*.h')                  do clang-format.exe -i -style=file LIBRARIES_FOR\AVR\%%F
:for /F %%F in ('dir /b LIBRARIES_FOR\PIC16\*.h')                do clang-format.exe -i -style=file LIBRARIES_FOR\PIC16\%%F
