...
void Transliterate(char* dest, char* str)
{
   ...
   for (; (*str); str++ ) {
       switch (str[0]) {
           case 'à':{dest[0]='a'; dest[1]=0; break;};
           case 'á':{dest[0]='b'; dest[1]=0; break;};
           case 'â':{dest[0]='v'; dest[1]=0; break;};
           case 'ã':{dest[0]='g'; dest[1]=0; break;};
           case 'ä':{dest[0]='d'; dest[1]=0; break;};
           case 'å':{dest[0]='e'; dest[1]=0; break;};
           case '´':{dest[0]='y'; dest[1]='e'; dest[2]=0; dest++; break;};
           case 'æ':{dest[0]='z'; dest[1]='h'; dest[2]=0; dest++; break;};
           case 'ç':{dest[0]='z'; dest[1]=0; break;};
           case 'è':{dest[0]='i'; dest[1]=0; break;};
           case 'é':{dest[0]='y'; dest[1]=0; break;};
           case 'ê':{dest[0]='k'; dest[1]=0; break;};
           case 'ë':{dest[0]='l'; dest[1]=0; break;};
           case 'ì':{dest[0]='m'; dest[1]=0; break;};
           case 'í':{dest[0]='n'; dest[1]=0; break;};
           case 'î':{dest[0]='o'; dest[1]=0; break;};
           case 'ï':{dest[0]='p'; dest[1]=0; break;};
           case 'ð':{dest[0]='r'; dest[1]=0; break;};
           case 'ñ':{dest[0]='s'; dest[1]=0; break;};
           case 'ò':{dest[0]='t'; dest[1]=0; break;};
           case 'ó':{dest[0]='u'; dest[1]=0; break;};
           case 'ô':{dest[0]='f'; dest[1]=0; break;};
           case 'õ':{dest[0]='h'; dest[1]=0; break;};
           case 'ö':{dest[0]='c'; dest[1]=0; break;};
           case '÷':{dest[0]='c'; dest[1]='h'; dest[2]=0; dest++; break;};
           case 'ø':{dest[0]='s'; dest[1]='h'; dest[2]=0; dest++; break;};
           case 'ù':{dest[0]='c'; dest[1]='h'; dest[2]=0; dest++; break;};
           case 'ú':{dest[0]='_'; dest[1]=0; break;};
           case 'û':{dest[0]='y'; dest[1]=0; break;};
           case 'ü':{dest[0]='_'; dest[1]=0; break;};
           case 'ý':{dest[0]='e'; dest[1]=0; break;};
           case 'þ':{dest[0]='y'; dest[1]='u'; dest[2]=0; dest++; break;};
           case 'ÿ':{dest[0]='y'; dest[1]='a'; dest[2]=0; dest++; break;};
           case 'À':{dest[0]='A'; dest[1]=0; break;};
           case 'Á':{dest[0]='B'; dest[1]=0; break;};
           case 'Â':{dest[0]='V'; dest[1]=0; break;};
           case 'Ã':{dest[0]='G'; dest[1]=0; break;};
           ...
           case 'Ý':{dest[0]='E'; dest[1]=0; break;};
           case 'Þ':{dest[0]='Y'; dest[1]='u'; dest[2]=0; dest++; break;};
           case 'ß':{dest[0]='Y'; dest[1]='a'; dest[2]=0; dest++; break;};
           default :{dest[0]=str[0]; dest[1]=0; break;};
       };
       dest++;
   }
}
