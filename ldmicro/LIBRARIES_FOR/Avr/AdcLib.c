...
// NB:	pas d'ADC sur ATMega 164
    ...
    defined (LDTARGET_atmega16) || defined (LDTARGET_atmega32) || \
    defined (LDTARGET_atmega64) || defined (LDTARGET_atmega128) || \
    defined (LDTARGET_atmega164) || defined (LDTARGET_atmega324) || \
