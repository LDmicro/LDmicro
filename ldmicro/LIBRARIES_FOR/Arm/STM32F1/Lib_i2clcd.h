...
#define BIT_LCD_RS   	0     // bit du port sur lequel est connectée le pin RS du LCD		// adapte pour IO-Expander facon Arduino
#define BIT_LCD_WR   	1     // bit du port sur lequel est connectée le pin WR du LCD		// inutilise
#define BIT_LCD_E   	2     // bit du port sur lequel est connectée le pin E du LCD		//
#define BIT_LCD_BL   	3     // bit du port sur lequel est connectée la pin BL du LCD		// backlight (facultatif)
#define BIT_LCD_D4   	4     // bit du port sur lequel est connectée le pin D4 du LCD		//
#define BIT_LCD_D5   	5     // bit du port sur lequel est connectée le pin D5 du LCD		//
#define BIT_LCD_D6   	6     // bit du port sur lequel est connectée le pin D6 du LCD		//
#define BIT_LCD_D7   	7     // bit du port sur lequel est connectée le pin D7 du LCD		//
