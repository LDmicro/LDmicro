...
McuIoPinInfo AvrAtmega16or32IoPinInfo[] = {
    { 'B',  0,  1, "PB0 (T0/XCK)" ,      0, "\0"},
    { 'B',  1,  2, "PB1 (T1)" ,      0, "\0"},
    { 'B',  2,  3, "PB2 (INT2/AIN0)" ,      0, "\0"},
    { 'B',  3,  4, "PB3 (OC0/AIN1)" ,      0, "\0"},
    { 'B',  4,  5, "PB4 (_SS)" ,      0, "\0"},
    { 'B',  5,  6, "PB5 (MOSI)" ,      0, "\0"},
    { 'B',  6,  7, "PB6 (MISO)" ,      0, "\0"},
    { 'B',  7,  8, "PB7 (SCK)" ,      0, "\0"},
    ...
    { 'C',  4, 26, "PC4 (TDO)" ,      0, "\0"},
    { 'C',  5, 27, "PC5 (TDI)" ,      0, "\0"},
    { 'C',  6, 28, "PC6 (TOSC1)" ,      0, "\0"},
    { 'C',  7, 29, "PC7 (TOSC2)" ,      0, "\0"},
    { 'A',  0, 40, "PA0 (ADC0)"  ,      0, "\0"},
    { 'A',  1, 39, "PA1 (ADC1)"  ,      0, "\0"},
    { 'A',  2, 38, "PA2 (ADC2)"  ,      0, "\0"},
    { 'A',  3, 37, "PA3 (ADC3)"  ,      0, "\0"},
...
McuIoPinInfo AvrAtmega16or32IoPinInfo44[] = {
    { 'B',  0, 40, "PB0 (T0/XCK)" ,      0, "\0"},
    { 'B',  1, 41, "PB1 (T1)" ,      0, "\0"},
    { 'B',  2, 42, "PB2 (INT2/AIN0)" ,      0, "\0"},
    { 'B',  3, 43, "PB3 (OC0/AIN1)" ,      0, "\0"},
    { 'B',  4, 44, "PB4 (_SS)" ,      0, "\0"},
    { 'B',  5,  1, "PB5 (MOSI)" ,      0, "\0"},
    { 'B',  6,  2, "PB6 (MISO)" ,      0, "\0"},
    { 'B',  7,  3, "PB7 (SCK)" ,      0, "\0"},
    ...
    { 'C',  4, 23, "PC4 (TDO)" ,      0, "\0"},
    { 'C',  5, 24, "PC5 (TDI)" ,      0, "\0"},
    { 'C',  6, 25, "PC6 (TOSC1)" ,      0, "\0"},
    { 'C',  7, 26, "PC7 (TOSC2)" ,      0, "\0"},
    { 'A',  0, 37, "PA0 (ADC0)" ,      0, "\0"},
    { 'A',  1, 36, "PA1 (ADC1)" ,      0, "\0"},
    { 'A',  2, 35, "PA2 (ADC2)" ,      0, "\0"},
    { 'A',  3, 34, "PA3 (ADC3)" ,      0, "\0"},
...
McuIoPinInfo AvrAtmega8IoPinInfo[] = {
    ...
    { 'D',  2,  4, "PD2 (INT0)" ,      0, "\0"},
    { 'D',  3,  5, "PD3 (INT1)" ,      0, "\0"},
    { 'D',  4,  6, "PD4 (XCK / T0)" ,      0, "\0"},
    { 'D',  5, 11, "PD5 (T1)" ,      0, "\0"},
    { 'D',  6, 12, "PD6 (AIN0)" ,      0, "\0"},
    { 'D',  7, 13, "PD7 (AIN1)" ,      0, "\0"},
    { 'B',  0, 14, "PB0 (ICP1)" ,      0, "\0"},
    { 'B',  1, 15, "PB1 (OC1A)" ,      0, "\0"},
    { 'B',  2, 16, "PB2 (SS / OC1B)" ,      0, "\0"},
    { 'B',  3, 17, "PB3 (MOSI / OC2)" ,      0, "\0"},
    { 'B',  4, 18, "PB4 (MISO)" ,      0, "\0"},
    { 'B',  5, 19, "PB5 (SCK)" ,      0, "\0"},
...
//  { 'B',  7, 10, "PB7 (XTAL2 / TOSC2)" },
    ...
    { 'C',  2, 25, "PC2 (ADC2)" ,      0, "\0"},
    { 'C',  3, 26, "PC3 (ADC3)" ,      0, "\0"},
    { 'C',  4, 27, "PC4 (ADC4 / SDA)" ,      0, "\0"},
    { 'C',  5, 28, "PC5 (ADC5 / SCL)" ,      0, "\0"},
//  { 'C',  6,  1, "PC6 (_RESET)" },
};
...
McuIoPinInfo AvrAtmega8IoPinInfo32[] = {
    // {char port;  int bit;  int pin;}
    { 'D',  0, 30, "PD0 (RXD)" ,      0, "\0"},
    { 'D',  1, 31, "PD1 (TXD)" ,      0, "\0"},
    { 'D',  2, 32, "PD2 (INT0)" ,      0, "\0"},
    { 'D',  3,  1, "PD3 (INT1)" ,      0, "\0"},
    { 'D',  4,  2, "PD4 (XCK / T0)" ,      0, "\0"},
    { 'D',  5,  9, "PD5 (T1)" ,      0, "\0"},
    { 'D',  6, 10, "PD6 (AIN0)" ,      0, "\0"},
    { 'D',  7, 11, "PD7 (AIN1)" ,      0, "\0"},
    { 'B',  0, 12, "PB0 (ICP1)" ,      0, "\0"},
    { 'B',  1, 13, "PB1 (OC1A)" ,      0, "\0"},
    { 'B',  2, 14, "PB2 (OC1B / SS)" ,      0, "\0"},
    { 'B',  3, 15, "PB3 (MOSI / OC2)" ,      0, "\0"},
    { 'B',  4, 16, "PB4 (MISO)" ,      0, "\0"},
    { 'B',  5, 17, "PB5 (SCK)" ,      0, "\0"},
    { 'B',  6,  7, "PB6 (XTAL1 / TOSC1)" ,      0, "\0"},
    { 'B',  7,  8, "PB7 (XTAL2 / TOSC2)" ,      0, "\0"},
    { 'C',  0, 23, "PC0 (ADC0)" ,      0, "\0"},
    { 'C',  1, 24, "PC1 (ADC1)" ,      0, "\0"},
    { 'C',  2, 25, "PC2 (ADC2)" ,      0, "\0"},
    { 'C',  3, 26, "PC3 (ADC3)" ,      0, "\0"},
...
//        A     B     C     D     E     F     G     H      I   J      K      L
        ...
        ARRAY_SIZE(AvrAtmega2560_100TQFPIoPinInfo),
        AvrAtmega2560_100TQFPAdcPinInfo,
        ARRAY_SIZE(AvrAtmega2560_100TQFPAdcPinInfo),
        1023,
        { 2 , 3 },
        23,
        ISA_AVR,
        ...
        ARRAY_SIZE(AvrAtmega2560PwmPinInfo),
        nullptr,
        0,
        McuSpiInfoATmega2560,
        ARRAY_SIZE(McuSpiInfoATmega2560),
    },
    {
        ...
        ARRAY_SIZE(AvrAT90USB647_64TQFPIoPinInfo),
        AvrAT90USB647_64TQFPAdcPinInfo,
        ARRAY_SIZE(AvrAT90USB647_64TQFPAdcPinInfo),
        1023,
        { 27, 28 },
        17,
        ISA_AVR,
...
//        A     B     C     D     E     F     G     H      I   J      K      L
        ...
        ARRAY_SIZE(AvrAtmega128_64TQFPIoPinInfo),
        AvrAtmega128_64TQFPAdcPinInfo,
        ARRAY_SIZE(AvrAtmega128_64TQFPAdcPinInfo),
        1023,
        { 27, 28 },
        17,
        ISA_AVR,
    ...
    },
    {
        ...
        ARRAY_SIZE(AvrAtmega162IoPinInfo),
        nullptr,
        0,
        0,
        { 0, 0 },
        ...
        ARRAY_SIZE(AvrAtmega162PwmPinInfo40_)
    },
    {
        ...
        ARRAY_SIZE(AvrAtmega16or32IoPinInfo),
        AvrAtmega16or32AdcPinInfo,
        ARRAY_SIZE(AvrAtmega16or32AdcPinInfo),
        1023,
        { 14, 15 },
        21, // OC2
        ISA_AVR,
        ...
        ARRAY_SIZE(AvrAtmega16_32PwmPinInfo40)
    },
    {
    ...
    },
    {
        ...
        { { 0x100, 512 } },
        AvrAtmega8IoPinInfo,
        ARRAY_SIZE(AvrAtmega8IoPinInfo),
        AvrAtmega8AdcPinInfo,
        ARRAY_SIZE(AvrAtmega8AdcPinInfo),
        1023,
        { 2, 3 },
        17,
        ISA_AVR,
    ...
    },
    {
        ...
        ARRAY_SIZE(AvrAtmega328IoPinInfo),
        AvrAtmega8AdcPinInfo,
        ARRAY_SIZE(AvrAtmega8AdcPinInfo),
        1023,
        { 2, 3 },
    ...
    },
    {
        ...
        ARRAY_SIZE(AvrAtmega164IoPinInfo),
        AvrAtmega164AdcPinInfo,
        ARRAY_SIZE(AvrAtmega164AdcPinInfo),
        1023,
        { 14, 15 },
        21,
        ISA_AVR,
    ...
    },
    {
        ...
        ARRAY_SIZE(AvrAtmega8IoPinInfo32),     //int              pinCount;
        AvrAtmega8AdcPinInfo32,              //McuAdcPinInfo   *adcInfo;
        ARRAY_SIZE(AvrAtmega8AdcPinInfo32),    //int              adcCount;
        1023,                                //int              adcMax;
...
//      ARRAY_SIZE(AvrAtmega8ExtIntPinInfo32),
        AvrPwmPinInfo32_,
        ARRAY_SIZE(AvrPwmPinInfo32_),
        AvrExtIntPinInfo32,
        ARRAY_SIZE(AvrExtIntPinInfo32)
    },
    {
        ...
        ARRAY_SIZE(AvrAtmega8IoPinInfo28),
        AvrAtmega8AdcPinInfo,
        ARRAY_SIZE(AvrAtmega8AdcPinInfo),
        1023,
        { 2, 3 },
...
//       (0x10 <<  0),  // INTOSC oscillator: I/O function on RA6/OSC2/CLKOUT pin, I/O function on RA7/OSC1/CLKIN
            */
        PicPwmPinInfo18,
        ARRAY_SIZE(PicPwmPinInfo18),
        PicExtIntPinInfo18,
        ARRAY_SIZE(PicExtIntPinInfo18)
    },
    {
        ...
        { { 0x20, 96 }, { 0xA0, 80 }, { 0x120, 48 } },
        Pic16F88PinIoInfo,
        ARRAY_SIZE(Pic16F88PinIoInfo),
        Pic16F88AdcPinInfo,
        ARRAY_SIZE(Pic16F88AdcPinInfo),
        1023,
        { 8, 11 },
        0,
        ISA_PIC16,
...
//          (1 << 16) | // FCMEN: Fail-Safe Clock Monitor enabled
    ...
    },
    {
        ...
        ARRAY_SIZE(Pic18PinIoInfo),
        Pic16F819AdcPinInfo,
        ARRAY_SIZE(Pic16F819AdcPinInfo),
        1023,
        { 0, 0 },
        0,
        ISA_PIC16,
...
//          (1 <<  4) | // 100 = INTRC oscillator; port I/O function on both RA6/OSC2/CLKO pin and RA7/OSC1/CLKI pin
    ...
    },
    {
        ...
        Pic16F877IoPinInfo,
        ARRAY_SIZE(Pic16F877IoPinInfo),
        Pic16F877AdcPinInfo,
        ARRAY_SIZE(Pic16F877AdcPinInfo),
        1023,
        { 26, 25 },
        16,
        ISA_PIC16,
        ...
        0x3f72,
        PicPwmPinInfo40,
        ARRAY_SIZE(PicPwmPinInfo40),
        PicExtIntPinInfo40,
        ARRAY_SIZE(PicExtIntPinInfo40)
    },
    {
        ...
        { { 0x20, 96 }, { 0xA0, 80 }, { 0x110, 96 }, { 0x190, 96 } },
        Pic16F876IoPinInfo,
        ARRAY_SIZE(Pic16F876IoPinInfo),
        Pic16F876AdcPinInfo,
        ARRAY_SIZE(Pic16F876AdcPinInfo),
        1023,
        { 18, 17 },
        12,
        ISA_PIC16,
        ...
        0x3f72,
        PicPwmPinInfo28_2,
        ARRAY_SIZE(PicPwmPinInfo28_2),
        PicExtIntPinInfo28,
        ARRAY_SIZE(PicExtIntPinInfo28)
    },
    {
        ...
        Pic16F887IoPinInfo,
        ARRAY_SIZE(Pic16F887IoPinInfo),
        Pic16F887AdcPinInfo,
        ARRAY_SIZE(Pic16F887AdcPinInfo),
        1023,
        { 26, 25 },
        16,
        ISA_PIC16,
    ...
    },
    {
        ...
        ARRAY_SIZE(Pic28Pin_SPDIP_SOIC_SSOP),
        Pic16F886AdcPinInfo,
        ARRAY_SIZE(Pic16F886AdcPinInfo),
        1023,
        { 18, 17 },
        12,
        ISA_PIC16,
...
//===========================================================================
    {
        ...
        ARRAY_SIZE(ControllinoMaxiIoPinInfo),
        ControllinoMaxiAdcPinInfo,
        ARRAY_SIZE(ControllinoMaxiAdcPinInfo),
        1023,
        { 2 , 3 },
        23,
        ISA_XINTERPRETED,
        ...
        ARRAY_SIZE(ControllinoMaxiPwmPinInfo),
    },
/*
    {
        "ANSI C Code",
...
{
    return ARRAY_SIZE(SupportedMcus);
}
